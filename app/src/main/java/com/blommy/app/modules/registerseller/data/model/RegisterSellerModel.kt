package com.blommy.app.modules.registerseller.`data`.model

import com.blommy.app.R
import com.blommy.app.appcomponents.di.MyApp
import kotlin.String

data class RegisterSellerModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtGroupSixtyNine: String? = MyApp.getInstance().resources.getString(R.string.lbl_user)
  ,
  /**
   * TODO Replace with dynamic value
   */
  var txtGroupSixtyEight: String? = MyApp.getInstance().resources.getString(R.string.lbl_seller)
  ,
  /**
   * TODO Replace with dynamic value
   */
